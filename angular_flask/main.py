...
def main(searched_spot):
    ...
    args = {
        'username': 'testeruserray',
        'password': 'testing',
        'location': '130 Sinaloa, Mexico City',
        'debug': None
    }
    ...
    results['access_token'] = '{}'.format(access_token[:25])
    ...
    results['api_endpoint'] = '{}'.format(api_endpoint)
    ...
    if response is not None:
        ...
        results['username'] = '{}'.format(profile.profile.username)
        ...
        for curr in profile.profile.currency:
            ...
            results['currency'].append('[+] {}: {}'.format(curr.type, curr.amount))
    else:
        print('[-] Ooops...')
    ...
    while True:
        ...
        for poke in visible:
            ...
            results['pokemon_close'].append({
                        ...
                        'distance_apart': int(origin.get_distance(other).radians * 6366468.241830914),
                        'direction': direction,
                        'poke_number': poke.pokemon.PokemonId,
